    ...
    <div class="row">
            <div class="col-sm">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        ...
                        <input name="tipo_auto" type="radio" aria-label="Radio button for following text input" value="Sedan">
                        </div>
                    </div>
                    <input type="label" class="form-control" value="Sedan" disabled>
                    <img src="<?=base_url('assets/recursos/vista_sedan.png')?>" class="img-fluid" alt="Responsive image">
            ...
            <div class="col-sm">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                        <input name="tipo_auto" type="radio" aria-label="Radio button for following text input" value="Pick-up sencilla">
                        </div>
                    </div>
                    <input type="label" class="form-control" value="Pick-up sencilla" disabled>
                    <img src="<?=base_url('assets/recursos/vista-pickup-sencilla.png')?>" class="img-fluid" alt="Responsive image">
            ...
            <div class="col-sm">
                ...
                <div class="input-group">
                    <div class="input-group-prepend">
                        <div class="input-group-text">
                        <input name="tipo_auto" type="radio" aria-label="Radio button for following text input" value="Pick-up Doble Cabina">
                        </div>
                    </div>
                    <input type="label" class="form-control" value="Pick-up Doble Cabina" disabled>
                    <img src="<?=base_url('assets/recursos/vista-pickup-doble-cabina.png')?>" class="img-fluid" alt="Responsive image">
    ...
    <div class="row">
        <div class="col-sm">
            ...
            <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                            <input name="tipo_auto" type="radio" aria-label="Radio button for following text input" value="Camioneta tipo SUV">
                            </div>
                        </div>
                        <input type="label" class="form-control" value="Camioneta tipo SUV" disabled>
                        <img src="<?=base_url('assets/recursos/Camioneta-SUV.png')?>" class="img-fluid" alt="Responsive image">
        ...
        <div class="col-sm">
            ...
            <div class="input-group">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                            <input name="tipo_auto" type="radio" aria-label="Radio button for following text input" value="Camioneta para pasajeros">
                            </div>
                        </div>
                        <input type="label" class="form-control" value="Camioneta para pasajeros" disabled>
                        <img src="<?=base_url('assets/recursos/Camioneta-pasajeros.png')?>" class="img-fluid" alt="Responsive image">
